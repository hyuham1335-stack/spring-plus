...
public class TodoController {
    ...
    public ResponseEntity<Page<TodoTestResponse>> getTodosWithOptions(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size,
        ...
        return ResponseEntity.ok(todoService.getTodosWithOptions(page, size, title, nickName, createFrom, createTo));
    }
}
